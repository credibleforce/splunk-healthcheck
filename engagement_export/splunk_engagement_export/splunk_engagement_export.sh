...
echo "-------------------------------"
echo "Exporting: $s"
/opt/splunk/bin/splunk search "| savedsearch $s" -app engagement_healthcheck -maxout 0 -preview 0 -output json -earliest_time -7d -latest_time now> engagement_data/$s.json
echo "Complete."
done
